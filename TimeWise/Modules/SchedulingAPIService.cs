...
public class SchedulingAPIService
{
    ...
    public async Task<TimeWise.Data.Scheduler.Solution?> GetSolution(TimeWise.Data.Scheduler.Problem problem)
    {
        try
        {
            ...
            var newOptions = new SchedulingLib.Options(problem.Options.StrainMinimizing, problem.Options.EnsureQualifiedPersonnelConstraint, problem.Options.NoDoubleShiftConstraint, problem.Options.MaximumWorkingHoursConstraint, problem.Options.MinimumWorkingHoursConstraint);
